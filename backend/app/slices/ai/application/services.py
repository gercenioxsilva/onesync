...
class AIProcessingService:
    ...
    def create_ai_config(
        ...
        config = AIConfigModel(
            ...
            prompt_template=prompt_template or AIConfigModel.__table__.columns['prompt_template'].default.arg
        )
    ...
    def update_ai_config(self, tenant_id: str, **kwargs) -> AIConfigModel:
        ...
        allowed_fields = {
            "provider", "api_key", "model_name", "auto_process_enabled",
            "temperature", "max_tokens", "monthly_quota", "prompt_template"
        }
