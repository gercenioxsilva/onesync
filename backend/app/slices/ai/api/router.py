...
from app.slices.ai.api.schemas import (
    ...
    AIProcessingLogOut, ProcessOneOnOneRequest, ProcessOneOnOneResponse
)
...
def create_ai_config(
    ...
    try:
        ...
        logger.info(f"AI config created for tenant {current_user.tenant_id} with provider {payload.provider}")
        return config
